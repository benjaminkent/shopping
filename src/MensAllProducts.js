...
class MensAllProducts extends Component {
  render() {
    const mensAllProducts = Data.filter(card => card.category === 'Mens')
...
export default MensAllProducts
