...
class WomensAllProducts extends Component {
  render() {
    const womensAllProducts = Data.filter(card => card.category === 'Womens')
        ...
        <section className="section">
          <div className="container">
            <h1 className="subtitle">
              <strong>Women's Department</strong>
            </h1>
          </div>
...
export default WomensAllProducts
